...
import { PostCart, PostWish, ProductsData } from '../https/axios'
...
const CategoryProduct = ({product}) => {
   ...
   useEffect(() => {
    async function min(){
        const pricearr = product.map((curElem) => curElem.price)
                  ...
                  <div className="row">
                      <div id="column-left" className="col-lg-3 col-md-3">
                          <div className="list-group">
                              ...
                              <h6>₹ {price} </h6>
                              <input type="range" min={minprice} max={maxprice} onChange={handleinput} />
                          </div>
                          {/* <div className="list-group">
